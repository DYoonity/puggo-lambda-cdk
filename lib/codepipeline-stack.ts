...
export class PuggoCodePipelineStack extends cdk.Stack {
  constructor(scope: Construct, id: string, props?: cdk.StackProps) {
    ...
    const lambdaStackStaging = new PuggoLambdaStack(stagingStage, "PuggoLambdaStack-Staging", {
      env: {
        account: "XXXXX",
        region: "us-east-1",
      },
    ...
    const lambdaStackProd = new PuggoLambdaStack(prodStage, "PuggoLambdaStack-Prod", {
      env: {
        account: "XXXXX",
        region: "us-east-1",
      },
